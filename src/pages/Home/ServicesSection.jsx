...
const SectionSubtitle = styled(Typography)(({ theme }) => ({
  ...
  fontWeight: 600,
  whiteSpace: "nowrap",
  [theme.breakpoints.down("sm")]: { padding: "2px 10px", fontSize: "12px" },
}));
...
const ServicesGrid = styled(Grid)(({ theme }) => ({
  ...
  maxWidth: "1300px",
  margin: "0 auto",
  [theme.breakpoints.down("lg")]: { flexDirection: "column", gap: "40px" },
}));
...
const ServicesList = styled(Box)(({ theme }) => ({
  ...
  textAlign: "left",
  padding: "0 40px",
  [theme.breakpoints.down("md")]: { padding: 0, width: "100%", minWidth: "auto" },
}));
...
const ServiceImage = styled(Box)(({ theme }) => ({
  ...
  "&:hover img": { transform: "scale(1.05)", boxShadow: "0 25px 70px rgba(0,0,0,0.2)" },
  [theme.breakpoints.down("md")]: {
    minWidth: "auto",
    width: "90%",
    "& img": { height: "300px" },
              ...
              return (
                <Card
                  ...
                  sx={{
                    ...
                    border: isActive ? `2px solid ${themeColors.orangeColor}` : "1px solid transparent",
                    marginBottom: "20px",
                    position: "relative",
                    cursor: "pointer",
                    transition: "all 0.5s ease",
                    ...
                    >
                      <Typography
                        sx={{
                          fontSize: "1rem",
                          fontWeight: 700,
                          color: isActive ? themeColors.orangeColor : "#999",
                        }}
                      >
                        {service.num}
                      </Typography>
                    ...
                    <Box sx={{ flex: 1 }}>
                      <Typography
                        sx={{
                          ...
                          color: isActive ? themeColors.deepBlack : "#777",
                        }}
                      >
                        {service.title}
                      </Typography>
                      {isActive && (
                        <Typography sx={{ color: "#555", mt: 2, fontSize: "0.95rem", lineHeight: 1.7 }}>
                          {service.desc}
                        </Typography>
                      )}
                    </Box>
