    ...
    <ServicesContainer>
      ...
      <ServicesGrid container>
        ...
        <Grid item xs={12} lg={6} display="flex" justifyContent="center">
          <ServiceImage data-aos="fade-right" data-aos-delay="200">
        ...
        <Grid item xs={12} lg={6} display="flex" justifyContent="center">
          <ServicesList data-aos="fade-left" data-aos-delay="300">
            <ActiveService data-aos="zoom-in" data-aos-delay="400">
